...
int minnieWidth=187;
Image menu,leaderboard,help,obstacle_1,obstacle_2,player_name;
...
int obstacle1_height=40;
int obstacle2_width=150;
int obstacle2_height=40;
int dx=10;
int j=0;
...
void update_running(){
    if(onPlatform4){
        ...
        minnieY=platform5Y+obstacle1_height-31;
    }
    else if(onPlatform6){
        minnieY=platform6Y+obstacle1_height-31;
    }
    else if(onPlatform1){
